...
#Imagefile2 = ["x2fpvuk_pred.npy", "2otd5q_pred.npy", "4uhzc7_pred.npy",
...
Imagefile4 = ["x4vowt_preda.npy", "2otd5q_preda.npy", "4uhzc7_preda.npy",
...
#  datafff = imageio.imread("w7v4b5.jpg")
   ...
   imgtest = databb[30:100,520:550]
   imgtest2 = im.fromarray(imgtest, 'RGB')
   #imgtest2.show()
   print("Img Test: ")

   
   # UPDATED ORANGE THRESHOLDING - [167  84  14]
...
#      for j in range(0,b):
 ...
 #  img2.show()
   ...
   for i in range(0,a1):
      for j in range(0,b1):
         if((datae[i,j,0] > 156) & (datae[i,j,1] < 179)):
            if((datae[i,j,1] > 72) & (datae[i,j,1] < 96)):
               if( ((datae[i,j,2] > 2) & (datae[i,j,2] < 26))):
  ...
  # img8.show()
   ...
   colorthresholdcount = [orange, yellow, gray, darkgray, lightgray, lightgray2, lightgray3]
      ...
      for i in range(0,a1):
         for j in range(0,b1):
            if((datae[i,j,0] > 156) & (datae[i,j,1] < 179)):
               if((datae[i,j,1] > 72) & (datae[i,j,1] < 96)):
                  if( ((datae[i,j,2] > 2) & (datae[i,j,2] < 26))):
                     #THRESHOLD ORANGE COLOR - [167  84  14]
                     datad[i,j,0] = 255
                     datad[i,j,1] = 0
                     datad[i,j,2] = 0
   ...
   if(chosencolorcount == lightgray2):
      ...
      for i in range(0,a1):
         for j in range(0,b1):
            if((datae[i,j,0] > 154) & (datae[i,j,226])):
  ...
  # img8.show()
   ...
   FinalImageMacerelb = np.zeros((e,d))
   FinalImageMacerel2 = img10
   print(a1)
   print(b1)
   print(c1)
