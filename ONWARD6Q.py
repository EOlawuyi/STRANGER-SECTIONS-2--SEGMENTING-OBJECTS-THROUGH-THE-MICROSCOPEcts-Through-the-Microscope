...
#      for j in range(0,b):
 ...
 #  img2.show()
   ...
   for i in range(0,a1):
      for j in range(0,b1):
         if((datae[i,j,0] > 209) & (datae[i,j,1] < 281)):
            if((datae[i,j,1] > 95) & (datae[i,j,1] < 166)):
               if( ((datae[i,j,2] > 0) & (datae[i,j,2] < 59))):
   ...
   for i in range(0,a1):
      for j in range(0,b1):
         if((datae[i,j,0] > 73) & (datae[i,j,0] < 133)):
            if((datae[i,j,1] > 71) & (datae[i,j,1] < 131)):
               if( ((datae[i,j,2] > 100) & (datae[i,j,2] < 110))):
   ...
   for i in range(0,a1):
      for j in range(0,b1):
         if((datae[i,j,0] > 107) & (datae[i,j,0] < 155)):
            if((datae[i,j,1] > 109) & (datae[i,j,1] < 157)):
               if( ((datae[i,j,2] > 113) & (datae[i,j,2] < 161))):
                  #THRESHOLD GRAY COLOR
                  #GRAY 1 - [103 101 105]
                  #GRAY 2 - [131 133 137]
                  #GRAY 3 - [182 190 191] 
   ...
   for i in range(0,a1):
      for j in range(0,b1):
         if((datae[i,j,0] > 155) & (datae[i,j,0] < 209)):
            if((datae[i,j,1] > 163) & (datae[i,j,1] < 217)):
               if((datae[i,j,2] > 164) & (datae[i,j,2] < 218)):
                  #THRESHOLD GRAY COLOR
                  #GRAY 1 - [103 101 105]
                  #GRAY 2 - [109 112 114]
                  #GRAY 3 - [182 190 191]
   ...
   for i in range(0,a1):
      for j in range(0,b1):
         if((datae[i,j,0] > 42) & (datae[i,j,0] < 78)):
            if((datae[i,j,1] > 39) & (datae[i,j,1] < 75)):
               if( ((datae[i,j,2] > 45) & (datae[i,j,2] < 81))):
