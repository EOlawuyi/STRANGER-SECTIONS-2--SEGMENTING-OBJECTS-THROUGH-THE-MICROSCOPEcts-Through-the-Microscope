...
#      for j in range(0,b):
 ...
 #  img2.show()
   ...
   for i in range(0,a1):
      for j in range(0,b1):
         if((datae[i,j,0] > 173) & (datae[i,j,0] < 185)):
            if((datae[i,j,1] > 176) & (datae[i,j,1] < 188)):
               if( ((datae[i,j,2] > 179) & (datae[i,j,2] < 191))):
                  #THRESHOLD LIGHT GRAY COLOR 2 [179 182 185]
                  lightgray2 = lightgray2 + 1
                  datad[i,j,0] = 255
                  datad[i,j,1] = 0
                  datad[i,j,2] = 0
   ...
   LiptiniteBrown = img8
   [a1,b1] = LiptiniteBrown.size
   FinalImageMacerel = np.zeros((a1,b1))
   FinalImageMacerelb = np.zeros((a1,b1))
   ...
   for i in range(0,a1-1):
      for j in range(0,b1-1):
         if((FinalImageMacerel2.getpixel((i,j)) != 0)):
   ...
   colorthresholdcount = [orange, yellow, brown, gray, darkgray, lightgray, lightgray2, lightgray3]
   ...
   if(chosencolorcount == lightgray2):
      print("Light Gray 2!")
      ImageColor[z] = "Light Gray 2"
      for i in range(0,b1-1):
         for j in range(0,a1-1):
            if((datae[i,j,0] > 154) & (datae[i,j,0] > 226)):
               if((datae[i,j,1] > 148) & (datae[i,j,1] < 221)):
                  if( ((datae[i,j,2] > 157) & (datae[i,j,2] < 229))):
                     #THRESHOLD LIGHT GRAY COLOR 2 [190 185 193]
                     datad[i,j,0] = 255
                     datad[i,j,1] = 0
                     datad[i,j,2] = 0
