...
#  datafff = imageio.imread("w7v4b5.jpg")
   ...
   for i in range(1,a1-1):
      for j in range(1,b1-1):
         ...
         averagepixelvalue = math.fsum([graythresh[i,j],graythresh[i,j-1],graythresh[i,j+1],graythresh[i-1,j],graythresh[i,j-1],graythresh[i,j+1],graythresh[i+1,j],graythresh[i,j-1],graythresh[i,j+1]])
         averagepixelvalue2 = averagepixelvalue/9
